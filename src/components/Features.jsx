              ...
              <div className="feature-text-container">
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text">
                    ...
                    <span className="text-white">
                      ...
                      design using the same alloy that spacecraft used to
                      mission to mars
                    </span>
                  </p>
                </div>
                <div className="flex-1 flex-center">
                  <p className="feature-text g_text">
                    ...
                    metal making these are lightest pro model ever{" "}
                    <span className="text-white">
                      you'll notice the difference the moment you picked up.
                    </span>
                  </p>
                </div>
              </div>
